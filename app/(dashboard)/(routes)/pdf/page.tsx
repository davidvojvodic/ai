  ...
  return (
    <main className="mx-auto max-w-7xl md:p-10 ">
      <div className="mt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 pb-5 sm:flex-row sm:items-center sm:gap-0">
        <h1 className="mb-3 font-bold text-5xl text-zinc-100">Moje datoteke</h1>
      ...
      {files && files?.length !== 0 ? (
        ...
        <div className="mt-16 flex flex-col items-center text-white gap-2">
          <Ghost className="h-8 w-8 text-white" />
          <h3 className="font-semibold text-xl">
            Nimate še naloženih pdf datotek
          </h3>
          <p>Naložimo prvi pdf</p>
        </div>
      )}
    </main>
  );
